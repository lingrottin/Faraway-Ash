...
date = 2022-05-28
description = "通常的 KVM 服务器都可以满足需求，完全不需要导入镜像便可体会 FreeBSD 操作系统的神奇力量。"
path = "2022/0528/15f850f8d974/"

[taxonomies]
tags = ["FreeBSD", "GRUB", "HostVDS", "Linux", "VPS", "安装", "服务器", "Tiny Core Linux", "运维"]
categories = ["星耀"]
...
![](https://uof.edu.kg/wp-content/uploads/2022/05/image-5.png)
...
![](https://uof.edu.kg/wp-content/uploads/2022/05/image-6-1024x614.png)

使用 root 登录（密码：mfsroot），运行 `bsdinstall` 指令来安装。

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-7-1024x574.png)

设置主机名

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-8-1024x575.png)
选择分区

**注意：RAM 小于 2GB 的、没有 RAID 需求的 VPS 不建议使用 ZFS。**

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-9-1024x576.png)]

分区

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-10-1024x586.png)

分区表

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-11-1024x566.png)]

选择最近的镜像，作为 HostVDS 用户，当然是选择俄罗斯

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-12-1024x578.png)
安装中

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-13-1024x576.png)
创建 root 用户

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-14-1024x580.png)

选择时区

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-15-1024x577.png)

附加组件

**注意：添加用户时，请把用户添加进 wheel 组**

![](https://uof.edu.kg/wp-content/uploads/2022/05/image-16-1024x573.png)
完成安装  
...
![](https://uof.edu.kg/wp-content/uploads/2022/05/image-17.png)
