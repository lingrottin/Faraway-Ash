...
date = 2022-06-22
description = "将有线的打印机接在路由器上，释放出无线的力量。"
path="2022/0622/9bfa6627568d/"

[taxonomies]
tags = ["OpenWrt", "HP", "CUPS", "编译", "路由器", "打印机", "安装", "DeskJet", "HPLIP", "外设", "服务器", "运维"]
categories = ["星耀"]
+++
# 前言
...
如果你不想编译，请直接跳到[使用二进制包](#precompiled)。编译的好处是可以把 CUPS 内置在固件镜像内，而且可以调整别的内容。
...
## 更改配置
如果你的设备不在 OpenWrt 的官方支持列表里，请直接跳到[使用二进制包](#precompiled)。
